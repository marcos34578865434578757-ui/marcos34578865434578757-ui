...
<!-- Typing SVG Slogan -->
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=26&pause=1000&color=3B82F6&center=true&vCenter=true&width=800&lines=Hi+there,+I'm+an+AI+Full-Stack+Developer+👋;A+Gen+Z+Coder+Born+in+2006+💻;Bridging+LLMs+with+Modern+Web+Tech+🚀;Actively+Looking+For+an+Internship!+🎯)](https://git.io/typing-svg)
...
[![Email Me](https://img.shields.io/badge/Email_Me-EA4335?style=for-the-badge&logo=Gmail&logoColor=white)](mailto:marcos34578865434578757@gmail.com)
...
Hi! I'm a passionate Gen Z developer born in **2006**, currently navigating the exciting intersection of **Artificial Intelligence and Full-Stack Development**. 

- 🧠 **What I do:** I specialize in integrating Large Language Models (LLMs) into robust frontend and backend architectures to build smart, scalable applications.
- ⚡ **My vibe:** An incredibly fast learner, highly motivated, and driven by curiosity. I believe age is just a number when it comes to shipping great code.
- 🎯 **Current Goal:** **Actively seeking an internship opportunity** where I can contribute my skills, learn from senior engineers, and create real-world impact.
